...
const translations = {
  ...
  am: {
    ...
    'contact.subtitle': 'Համագործակցության և նկարներ ձեռքբերելու համար։',
    ...
    'gallery.page.description': 'Ուսումնասիրեք իմ գեղարվեստական ճանապարհորդությունը նկարների, քանդակների և փողոցային արվեստի միջոցով: Յուրաքանչյուր ստեղծագործություն պատմում է հույզերի, տեխնիկայի և ստեղծարար արտահայտության պատմություն:',
    ...
    'exhibitions.page.description': 'Ճանապարհորդություն իմ գեղարվեստական կարիերան ձևավորող հիմնական ցուցահանդեսների միջով, ներառյալ Հայաստանի և աշխարհի տարբեր երկրների ցուցադրությունների գլխավոր իրադարձությունները:',
